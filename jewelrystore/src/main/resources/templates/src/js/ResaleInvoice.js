    ...
    var content = `
        <div class="text-center mb-8">
            <div class="flex justify-between items-center">
                <div class="text-left">
                    ...
                    <h1 class="text-xl font-bold">CÔMG TY 2KS1NET </h1>
                </div>
            ...
            <tbody>
                ${data.listOrderInvoiceDetail.map(item => `
                    <tr class="text-center">
                        ...
                        <td class="p-2 border border-zinc-300">${item.price}</td>
                        <td class="p-2 border border-zinc-300">${item.totalPrice}</td>
                    </tr>
                `).join('')}
            </tbody>
        </table>
        <div class="flex justify-between mb-8">
            ...
            <div class="text-right">
                <p class="font-bold">Tổng cộng: ${data.totalPrice}</p>
            </div>
        </div>
        <div class="text-center mb-8">
