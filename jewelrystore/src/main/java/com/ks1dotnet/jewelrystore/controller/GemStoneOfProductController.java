...
// import
// com.ks1dotnet.jewelrystore.service.serviceImp.IGemStoneCategoryService;
// import
// com.ks1dotnet.jewelrystore.service.serviceImp.IGemStoneOfProductService;
...
// GemStoneCategoryDTO gscT =
// iGemStoneCategoryService.findById(id_gemStone_category);
// ProductDTO product = iProductService.findById(id_product);
// if (gs == null) {
// return new ResponseEntity<>(new responseData(404, "Gem stone of product not
// found", null),HttpStatus.NOT_FOUND);
// }
// gs.setCarat(carat);
...
// // } catch (Exception e) {
// // return new ResponseEntity<>(
// // new responseData(400, "Error update gem stone of product: " +
// e.getMessage(),
// // null),
// // HttpStatus.BAD_REQUEST);
// // }
