...
// public ResponseEntity<ResponseData> getCustomerTypesByPromotion(@PathVariable
// int promotionId) {
// ResponseData responseData =
// iForCustomerService.getCustomerTypesByPromotionId(promotionId);
...
// ResponseData responseData =
// iForCustomerService.applyPromotionToCustomerTypes(applyPromotionDTO);
// return new ResponseEntity<>(responseData, responseData.getStatus());
// }
...
// @RequestBody ApplyPromotionDTO applyPromotionDTO) {
// ResponseData responseData =
// iForCustomerService.removePromotionFromCustomerTypes(applyPromotionDTO);
// return new ResponseEntity<>(responseData, responseData.getStatus());
// }

// @GetMapping("/check-customer/{customerTypeId}/{promotionId}")
// public ResponseEntity<ResponseData>
// checkCustomerTypeInOtherActivePromotions(@PathVariable int customerTypeId,
// @PathVariable int promotionId) {
// ResponseData responseData =
// iForCustomerService.checkCustomerTypeInOtherActivePromotions(customerTypeId,
// promotionId);
...
// public ResponseEntity<ResponseData>
// getCustomerTypesNotInPromotion(@PathVariable int promotionId) {
// ResponseData responseData =
// iForCustomerService.getCustomerTypesNotInPromotion(promotionId);
// return new ResponseEntity<>(responseData, responseData.getStatus());
// }
// }
