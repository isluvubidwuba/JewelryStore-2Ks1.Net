...
public class ForProductService implements IPromotionGenericService<Product> {
    ...
    public ResponseData checkInOtherActivePromotions(int entityId, int promotionId) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'checkInOtherActivePromotions'");
    }

    @Override
    public ResponseData getEntitiesNotInPromotion(int promotionId) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getEntitiesNotInPromotion'");
    }

    @Override
    public ResponseData getEntitiesInPromotion(int promotionId) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getEntitiesInPromotion'");
    }
...
// iForProductRepository.findProductsByPromotionId(promotionId);
// if (forProducts.isEmpty()) {
// throw new ResourceNotFoundException("No products found for the given
// promotion id: " + promotionId);
// }

// List<ForProductDTO> forProductDTOs = forProducts.stream().map(fp -> new
// ForProductDTO(
// fp.getId(),
...
// return new ResponseData(HttpStatus.OK, "Products found successfully",
// forProductDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to get products by promotion id",
// e.getMessage());
// }
// }
...
// iForProductRepository.findProductsNotInPromotion(promotionId);
// if (products.isEmpty()) {
...
// return new ResponseData(HttpStatus.OK, "Products not in the given promotion
// found successfully",
// productDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to get products not in the given
// promotion", e.getMessage());
// }
// }

// @Override
// public ResponseData applyPromotionToProducts(ApplyPromotionDTO
// applyPromotionDTO) {
// try {
...
// throw new ResourceNotFoundException("Promotion not found with id: " +
// promotionId);
...
// checkProductInOtherActivePromotions(product.getId(), promotionId);
// if (checkResponse.getStatus() == HttpStatus.CONFLICT) {
// List<PromotionDTO> otherPromotions = (List<PromotionDTO>)
...
// forProductsToSave.add(new ForProduct(new Promotion(promotionDTO), product,
// true));
// }
// }
...
// return new ResponseData(HttpStatus.OK, "Promotion applied to products
// successfully", productDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to apply promotion to products",
// e.getMessage());
// }
// }

// @Override
// public ResponseData removePromotionFromProducts(ApplyPromotionDTO
// applyPromotionDTO) {
// try {
// int promotionId = applyPromotionDTO.getPromotionId();
// List<Integer> productIds = applyPromotionDTO.getProductIds();
...
// if (forProducts.isEmpty()) {
// throw new BadRequestException("No products found with the given ids in the
// promotion");
// }
...
// return new ResponseData(HttpStatus.OK, "Promotion removed from products
// successfully", null);
// } catch (Exception e) {
// throw new BadRequestException("Failed to remove promotion from products",
// e.getMessage());
// }
// }

// @Override
// public ResponseData checkProductInOtherActivePromotions(int productId, int
// currentPromotionId) {
// List<ForProduct> forProducts =
// iForProductRepository.findActiveProductPromotionsByProductId(productId);

// if (forProducts.isEmpty()) {
// return new ResponseData(HttpStatus.OK, "Product is not in any other active
// promotions", null);
// }
...
// promotions", null);
// } else {
// return new ResponseData(HttpStatus.CONFLICT, "Product is active in other
