...
// iForCustomerRepository.findCustomerTypesByPromotionId(promotionId);
...
// List<ForCustomerDTO> forCustomerDTOs = forCustomers.stream().map(fc -> new
// ForCustomerDTO(
// fc.getId(),
...
// forCustomerDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to get customer types by promotion id",
// e.getMessage());
// }
// }
...
// @Override
// @Transactional
// public ResponseData applyPromotionToCustomerTypes(ApplyPromotionDTO
// applyPromotionDTO) {
// try {
...
// iCustomerTypeRepository.findAllById(customerTypeIds);
...
// checkCustomerTypeInOtherActivePromotions(customerType.getId(),
// promotionId);
...
// forCustomersToSave.add(new ForCustomer(new Promotion(promotionDTO),
// customerType, true));
// }
// }
...
// return new ResponseData(HttpStatus.OK, "Promotion applied to customer types
// successfully", forCustomerDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to apply promotion to customer types",
// e.getMessage());
// }
// }

// @Override
// public ResponseData removePromotionFromCustomerTypes(ApplyPromotionDTO
// applyPromotionDTO) {
// try {
// int promotionId = applyPromotionDTO.getPromotionId();
// List<Integer> customerTypeIds = applyPromotionDTO.getProductIds();
...
// throw new BadRequestException("No customer types found with the given ids in
// the promotion");
// }
...
// return new ResponseData(HttpStatus.OK, "Promotion removed from customer types
// successfully", null);
// } catch (Exception e) {
// throw new BadRequestException("Failed to remove promotion from customer
// types", e.getMessage());
// }
// }

// @Override
// public ResponseData checkCustomerTypeInOtherActivePromotions(int
// customerTypeId, int currentPromotionId) {
// List<ForCustomer> forCustomers = iForCustomerRepository
// .findActiveCustomerPromotionsByCustomerTypeId(customerTypeId);

// if (forCustomers.isEmpty()) {
// return new ResponseData(HttpStatus.OK, "Customer type is not in any other
// active promotions", null);
// }
...
// active promotions", null);
// } else {
// return new ResponseData(HttpStatus.CONFLICT, "Customer type is active in
// other promotions",
// otherPromotions);
// }
// }
...
// customerTypes.stream().map(CustomerType::getDTO)
// .collect(Collectors.toList());
// return new ResponseData(HttpStatus.OK, "Customer types not in promotion found
// successfully",
// customerTypeDTOs);
// } catch (Exception e) {
// throw new BadRequestException("Failed to get customer types not in
